...
final public class SharedPrefsUtils {
    ...
    /**
     * Helper method to retrieve a List value from {@link SharedPreferences}.
     *
     * @param context      a {@link Context} object.
     * @param key
     * @return The value from shared preferences, or the provided default.
     */
    public static Set getListPreference(Context context, String key) {
        Set value = null;
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            value = preferences.getStringSet(key,value);
        }
        return value;
    }

    /**
     * Helper method to write a Set value to {@link SharedPreferences}.
     *
     * @param context a {@link Context} object.
     * @param key
     * @param value
     * @return true if the new value was successfully written to persistent storage.
     */
    public static boolean setListPreference(Context context, String key, Set value) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            SharedPreferences.Editor editor = preferences.edit();
