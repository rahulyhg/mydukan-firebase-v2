        ...
        if(!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") &&
            ...
            Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication(AppContants.GMAIL_EMAIL_ID,AppContants.GMAIL_PASSWORD);
                }
            });
...
// send email
            ...
            try {
                t.connect("smtp.gmail.com",Integer.parseInt(_port),AppContants.GMAIL_EMAIL_ID,AppContants.GMAIL_PASSWORD);
