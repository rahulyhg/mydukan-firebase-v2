   ...
   /* @Override
    ...
    private static void removeFollowing(final Feed feed) {
        ...
        try {
            ...
            new SendEmail().sendEmail("Exception - FeedProfileFollowActivity - removeFollowing : ",e.toString());
            Crashlytics.log(0,"Exception - FeedProfileFollowActivity - removeFollowing : ",e.toString());
        }catch (VirtualMachineError ex){
            StringWriter errors = new StringWriter();
            ex.printStackTrace(new PrintWriter(errors));
            new SendEmail().sendEmail("FeedProfileFollowActivity - removeFollowing : ",ex.toString());
            Crashlytics.log(0,"FeedProfileFollowActivity - removeFollowing : ",ex.toString());
        }
