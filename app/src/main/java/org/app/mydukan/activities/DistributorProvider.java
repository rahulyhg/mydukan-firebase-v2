...
public class DistributorProvider extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor_provider);
        ...
        state_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                City_Adapter = new ArrayAdapter<String>(DistributorProvider.this,android.R.layout.simple_spinner_item,mCity);
    ...
    private void setupDropdownList(HashMap<String, List<Object>> state_cityName) {
        ...
        State_Adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item, stateNames);
        //set the view for the Drop down list
...
*/
    ...
    public void setupServiceCenterPage(ArrayList<ServiceCenterInfo> upServiceCenterPage) {
        ...
        adapter = new ServiceCenterAdapter(DistributorProvider.this, upServiceCenterPage);
