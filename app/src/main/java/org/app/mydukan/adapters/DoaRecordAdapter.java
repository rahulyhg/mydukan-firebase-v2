...
public class DoaRecordAdapter extends RecyclerView.Adapter<DoaRecordAdapter.ViewHolder> {
    ...
    public DoaRecordAdapter(Context context) {
        mContext = context;
        mRecordsList = new ArrayList<DoaRecord>();
        mApp = (MyDukan) mContext.getApplicationContext();
        //mListener = listener;
    }

    public void addItems(ArrayList<DoaRecord> list) {
        mRecordsList.clear();
        mRecordsList.addAll(list);
    }

    @Override
    public DoaRecordAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DoaRecordAdapter.ViewHolder(contactView);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            mSettledByView = (TextView) itemView.findViewById(R.id.amountID);
            mImeiView = (TextView) itemView.findViewById(R.id.settledbyID);
