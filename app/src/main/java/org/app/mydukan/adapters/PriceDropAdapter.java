...
public class PriceDropAdapter extends RecyclerView.Adapter<PriceDropAdapter.ViewHolder>{
    ...
    public PriceDropAdapter(ArrayList<Product> productArrayList, Context context, HashMap<String, Integer> map, List<String> categoryList) {
    ...
    @Override
    public void onBindViewHolder(PriceDropAdapter.ViewHolder holder, int position) {
